...
namespace Campus_Gate_KOU
{
    public partial class Reports : MetroFramework.Forms.MetroForm
    {
        ...
        private void allRecordsBtn_Click(object sender, EventArgs e)
        {
            ...
            string sqlSelectAll = "SELECT * from logs_ ORDER BY id DESC";
        ...
        private void recordSearchBtn_Click(object sender, EventArgs e)
        {
            MySqlConnection conn = new MySqlConnection(str_conn);
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("SELECT * FROM logs_", conn);
            ...
            if (!string.IsNullOrEmpty(search1) && search1 != "(Ad, Soyad)")
            {
                ...
                //1. TextBox
                MySqlCommand cmdS1 = new MySqlCommand("SELECT * FROM users " +
            ...
            {
                //2.TextBox
                MySqlCommand cmdS2 = new MySqlCommand("SELECT * FROM users " +
            ...
            {
                //3. TextBox
                MySqlCommand cmdS3 = new MySqlCommand("SELECT * FROM users " +
